...
public class LessonTransportActivity extends AppCompatActivity {
    ...
    String lessonStarter = "Let’s talk about travel transport in Spanish! We will only communicate in Spanish. Do your best to use cognates and context clues to help you out! If you’re stuck, use a dictionary or translation tool to help. Reply to this sentence in Spanish “¿Para cuántas noches quieres reservar tu hotel en Madrid?”";
    String lessonPrompt = "This is a Spanish lesson about travel transport. The text I started this message with in the parenthesis should be in Spanish. If it is not, tell me to speak in Spanish instead and ask me another question about travel transport. If what I said in Spanish is not logical or has spelling or grammar errors, please tell me in 1-3 sentences what the problem with it is then ask me another question about travel transport. If what I said in the parenthesis is in correct Spanish, please give me a quick 1-3 sentence response to that and ask me another question in Spanish to answer relating to travel transport.";
