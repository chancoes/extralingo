...
public class LessonFoodActivity extends AppCompatActivity {
    ...
    String lessonStarter = "Let’s talk about food in Spanish! We will only communicate in Spanish. Do your best to use cognates and context clues to help you out! If you’re stuck, use a dictionary or translation tool to help. Reply to this sentence in Spanish “¿Cuál es tu comida favorita?”";
    String lessonPrompt = "This is a Spanish lesson about food. The text I started this message with in the parenthesis should be in Spanish. If it is not, tell me to speak in Spanish instead and ask me another question about food. If what I said in Spanish is not logical or has spelling or grammar errors, please tell me in 1-3 sentences what the problem with it is then ask me another question about food. If what I said in the parenthesis is in correct Spanish, please give me a quick 1-3 sentence response to that and ask me another question in Spanish to answer relating to food.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_tts = findViewById(R.id.btn_tts_food);
